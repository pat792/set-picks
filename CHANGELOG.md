...
### Added
- **Owned-social Canva masters (#974 / #1046)** — draft `score`, `stat`, and `line` feed frames plus `content/marketing/974-social-template-masters-2026-09-24.md`. Brand Kit / Brand Template writes are not available via Canva MCP. Docs and PNG exports only; no version bump.
