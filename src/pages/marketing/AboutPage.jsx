...
import { AboutPageContent, MarketingPageShell } from '../../features/landing';
import { SEO_CONFIG } from '../../shared/config/seo';
import { getPrerenderRoute } from '../../shared/config/seoRoutes';

const route = getPrerenderRoute('/about');
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Setlist Pick 'Em — about the setlist prediction game"
        />
