/**
 * Decode Firestore REST API document payloads (no Admin SDK / no App Check).
 * Used by SEO prerender (#928) and public `/tour-stats` (#869) against
 * world-readable aggregates.
 */
