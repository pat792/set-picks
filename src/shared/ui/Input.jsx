...
const textBase =
  'w-full min-w-0 rounded-xl border-2 border-border-subtle bg-surface-field py-3 px-4 font-bold text-slate-100 outline-none transition-colors placeholder:text-slate-500 disabled:cursor-not-allowed disabled:opacity-50 read-only:opacity-80';
...
const checkboxBase =
  'h-4 w-4 shrink-0 rounded border-border-muted text-brand-primary focus:ring-2 focus:ring-brand-primary/40';
