...
const textBase =
  'w-full min-w-0 rounded-xl border-2 border-slate-700/60 bg-slate-900/50 py-3 px-4 font-bold text-slate-100 outline-none transition-colors placeholder:text-slate-500 disabled:cursor-not-allowed disabled:opacity-50 read-only:opacity-80';
